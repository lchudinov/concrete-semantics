...
IfTrue: "bval b s = Some True \<Longrightarrow> (IF b THEN c1 ELSE c2,s) \<rightarrow> (c1,s)"|
IfFalse: "bval b s = Some False \<Longrightarrow> (IF b THEN c1 ELSE c2,s) \<rightarrow> (c2,s)"|
