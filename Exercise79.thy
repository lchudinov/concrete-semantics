theory Exercise79 imports BExp Star
begin
...
inductive_cases OrSE[elim!]: "(c1 OR c2, s) \<rightarrow> ct"
...
next
  case Or1
  thus ?case 
  by (meson small_step.Or1 star.simps) 
next case Or2
  thus ?case
    by (meson small_step.Or2 star.simps)
qed
